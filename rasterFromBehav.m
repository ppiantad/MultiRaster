...
function raster = rasterFromBehav(fileName)
...
plot([CorrectTrial;CorrectTrial],yyCor,'color',blue);
plot([IncATrial;IncATrial],yyInA,'color',red);
plot([IncBTrial;IncBTrial],yyInB,'color',green);
